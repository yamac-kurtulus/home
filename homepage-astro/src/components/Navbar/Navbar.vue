<template>
  <nav>
    <div class="flex mx-16">
      ...
      <div class="flex flex-initial w-1/2 m-8" id="homelink">
        <NavLink href="/" label="Home" :active="isActive('\/')" />
      </div>
      <!-- </div> -->
      <!--mobile menu button-->
      <div class="md:hidden text-main-red flex flex-row-reverse w-1/2 row-end-auto m-4">
      ...
      <div class="md:flex-row-reverse md:w-1/2 md:row-end-auto md:flex hidden">
        <ul id="pagelinks-desktop" class="flex flex-row m-8">
    ...
    <div v-show="showTopMenu">
      <ul id="pagelinks-mobile" class="text-main-red flex flex-row">
